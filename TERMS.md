...
- **As-is software.** Kabootar is free, open-source software provided "as is",
  without warranty of any kind, under the [MIT License](LICENSE). The authors are
  not liable for any loss or damage arising from its use.
- **Best-effort delivery.** Delivery depends on other devices being in range to
...
- **Respect the law.** Use Kabootar in accordance with the laws that apply to you.
