...
abstract class Legal {
  static const String privacy =
      'studchat is built to keep your conversations yours.\n\n'
      ...
      'carried and relayed by other nearby studchat users’ devices until it '
      ...
      'used only to discover and connect to nearby devices. studchat does not '
      ...
      'please do not use studchat for sensitive information.';

  static const String terms =
      'By using studchat you agree to the following.\n\n'
      '• As-is software. studchat is free, open-source software provided '
      ...
      'range to carry your message. studchat does not guarantee that any '
      ...
      'send. Do not use studchat to send unlawful, harassing, or harmful '
      'content, or to infringe anyone’s rights.\n\n'
      '• Respect the law. Use studchat in accordance with the laws that apply '
      'to you.\n\n'
