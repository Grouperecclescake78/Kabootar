...
Studchat is built to keep your conversations yours. In plain language:
...
- **How messages travel.** Messages move directly between phones over Bluetooth
  ...
  by other nearby Studchat users' devices until it is delivered. Relays are not
  the intended recipient, but in this version **messages are not end-to-end
  encrypted**, so treat them as not fully private from a determined nearby party.
- **Permissions.** Bluetooth, nearby-Wi-Fi, and location permissions are used
  **only** to discover and connect to nearby devices. Studchat does **not**
...
End-to-end encryption is the top item on the [roadmap](README.md#-roadmap).
Until then, please do not use Studchat for sensitive information.

Questions? Open an issue or a private
[security advisory](https://github.com/royalpinto007/studchat/security/advisories/new).
